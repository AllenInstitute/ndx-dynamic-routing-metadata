...
__spec_path = __location_of_this_file / "spec" / "ndx-dynamic-routing-metadata.namespace.yaml"

# If that path does not exist, we are likely running in editable mode. Use the local path instead
if not os.path.exists(__spec_path):
    __spec_path = __location_of_this_file.parent.parent.parent / "spec" / "ndx-dynamic-routing-metadata.namespace.yaml"
