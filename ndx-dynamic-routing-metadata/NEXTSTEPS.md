...
# Next Steps for ndx-dynamic-routing-metadata Extension for NWB

## Creating Your Extension

1. In a terminal, change directory into the new ndx-dynamic-routing-metadata directory: `cd ndx-dynamic-routing-metadata`
...
`spec/ndx-dynamic-routing-metadata.namespace.yaml` and
`spec/ndx-dynamic-routing-metadata.extensions.yaml` files.
...
2. Start a git repository for your extension directory ndx-dynamic-routing-metadata
...
8. Make a release for the extension on GitHub with the version number specified. e.g. if version is 0.1.0, then this page should exist: https://github.com/arjunsridhar12345/ndx-dynamic-routing-metadata/releases/tag/0.1.0 . For instructions on how to make a release on GitHub see [here](https://help.github.com/en/github/administering-a-repository/creating-releases).
...
9. Publish your updated extension on [PyPI](https://pypi.org/).
    ...
    - If your extension version is 0.1.0, then this page should exist: https://pypi.org/project/ndx-dynamic-routing-metadata/0.1.0
...
`staged-extensions/ndx-dynamic-routing-metadata`:

    ```bash
    cp -r staged-extensions/example staged-extensions/ndx-dynamic-routing-metadata
    ```

13. Edit `staged-extensions/ndx-dynamic-routing-metadata/ndx-meta.yaml`
with information on where to find your NWB extension.
    ...
    - You may copy and modify the following YAML that was auto-generated:
      ...
      version: 0.1.0
      src: https://github.com/arjunsridhar12345/ndx-dynamic-routing-metadata
      pip: https://pypi.org/project/ndx-dynamic-routing-metadata/
      license: MIT
      maintainers: 
        - arjunsridhar12345
        - bjhardcastle
...
14. Edit `staged-extensions/ndx-dynamic-routing-metadata/README.md`
to add information about your extension. You may copy it from
`ndx-dynamic-routing-metadata/README.md`.

  ```bash
  cp ndx-dynamic-routing-metadata/README.md staged-extensions/ndx-dynamic-routing-metadata/README.md
  ```

15. Add and commit your changes to Git and push your changes to GitHub.
```
cd staged-extensions
git add ndx-dynamic-routing-metadata
git commit -m "Add new catalog entry for ndx-dynamic-routing-metadata" .
git push
```
...
ndx-dynamic-routing-metadata-record will be created in the nwb-extensions
GitHub organization and you will be added as a maintainer for that repository.


## Updating Your Published Extension

1. Update your ndx-dynamic-routing-metadata GitHub repository.

2. Publish your updated extension on PyPI.

3. Fork the ndx-dynamic-routing-metadata-record repository on GitHub.
